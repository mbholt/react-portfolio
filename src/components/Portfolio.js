    ...
    return (
        <section id="projects" className="work">
            ...
            <div className="projects">
                <a className="project1" title="Link to Paw-sible Pet" href="https://stark-mountain-98043.herokuapp.com/">
                    <div className="project-description">
                        <h5>Paw-sible Pet</h5>
                        <p>React, GraphQL, MongoDB, Express, Node.js</p>
                    </div>
                </a>

                <div className="projects-middle">
                    <a className="project2" title="Link to Live-Hire" href="https://gentle-dawn-52689.herokuapp.com/">
                        <div className="project-description">
                            <h5>Live-Hire</h5>
                            <p>HTML/CSS/JavaScript/Node/Handlebars</p>
                        </div>
                    </a>
                    <a className="project3" title="Link to Note Eater" href="https://foglea10.github.io/Note-Eater/">
                        <div className="project-description">
                            <h5>Note Eater</h5>
                            <p>JavaScript/CSS</p>
                        </div>    
